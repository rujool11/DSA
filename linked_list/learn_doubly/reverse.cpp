// Code from takeuforward, try to implement in DLL.cpp after checking all linkages
// (identical (with proper changes since DLL.cpp uses a LinkedList class)  implementation was not working )
#include <iostream>
#include <bits/stdc++.h>
